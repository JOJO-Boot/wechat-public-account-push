...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxd30e30b8bec2d8c0',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '59e7ae5bdc5173a0de184ae426169590',
  ...
  USERS: [
    {
      ...
      id: 'oUVyC6vc_jtYu35Mj_2N6Rh1MEYk',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'dRgDSd5xGPJyrwXtURFp5oHM03UDdVRDqZiCnRw3ZWA',
      // 所在省份
      province: '河南',
      // 所在城市
      city: '郑州',
